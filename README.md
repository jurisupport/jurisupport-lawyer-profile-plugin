...
JuriSupport 변호사 프로필 Claude Code 플러그인은 변호사가 자신의 업무 경험, 사건 자료, 상담 방향을 바탕으로 스스로 읽고 활용할 수 있는 개인 프로필을 완성하도록 돕습니다.
...
이 플러그인 자체가 프로필을 자동 공개하거나 의뢰인을 배정하지는 않습니다. 원본 사건기록은 자동으로 올라가지 않습니다. JuriSupport에 올리려면 먼저 웹에서 가입·로그인하고 동의 절차를 마쳐야 하며, 공개와 노출은 별도 검토 절차를 따릅니다.
...
8. 원하면 JuriSupport 웹에서 가입·로그인 후 동의 페이지를 완료합니다.
...
웹 동의가 없으면 JuriSupport에 프로필을 올릴 수 없습니다. 프로필을 올리는 것과 공개 승인·노출 시작은 별도 단계입니다.
